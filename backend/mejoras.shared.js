...
MEJORAS.push({
  ...
  activacionRapida: false, // Requiere apuntar
  elemento: 'roca',
  descripcion: 'Daño: 65, CD: 3s, Radio: 105, Rango: 680, castTime: 0.7s. roca que cae del cielo tras 0.7s en el área objetivo, generando un área de lodo que ralentiza a los enemigos un 50% durante 2s.',
});
