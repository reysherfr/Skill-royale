...
MEJORAS.push({
  ...
  stackDamage: 1, // 1 de daño por segundo por stack (compartido con dardo)
...
MEJORAS.push({
  ...
  descripcion: 'Invoca una ventisca helada en un área rectangular (300x200). Inflige 20 daño cada 0.5s durante 2.5s. Ralentiza 40% por 1.5s. 4 impactos congelan al enemigo por 1s. CD: 42s, Rango: 650.'
});
